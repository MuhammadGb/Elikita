...
import { buttonVariants } from "@/components/Globals/ui/button";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-brand-1000 text-slate-50 hover:bg-brand-900 hover:text-slate-50 focus:bg-brand-1000 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today:
      ...
      disabledDays={disablePastDates ? { before: today } : undefined}
      components={{
